...
POLCAL_SCAN = ['265','253','267','280']
#POLCAL_SCAN = ['266','277','245','255']
#POLCAL_SCAN = ['268','166','186','208']
...
if 1 in mysteps:
  ...
  SCRIPT_NAME = 'STEP1'
  keyw = {'EXPNAME':EXPNAME, 'DIFX_DIR':DIFX_DIR, 'DOSCAN':POLCAL_SCAN, 'CHANSOL': CHAVG, 'USE_PCAL':USE_PCAL,'EXCLUDE_BASELINES':EXCLUDE_BASELINE,'DOAMP':SOLVE_AMP,'DOIF':DOIF,'PLOTANT':REFANT, 'APPLY_AMP':APPLY_AMP}
